...
const TopSection = () => {
    return (
        ...
        >
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6 min-h-screen pt-0 lg:pt-6  pb-[var(--header-height)] max-w-7xl mx-auto px-6 font-serif">
